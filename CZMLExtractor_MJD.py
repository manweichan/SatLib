...
class CZMLExtractor_MJD:
    ...
    def add_communication(
        ...
        reference2 : str
            id of 2nd reference
        true_time_intervals : list of strings
            time intervals when the two references are close enough to communicate
        time_intervals : list of dictionaries
            time intervals and whether or not they are communicating
        line_width : int
            thickness of the line
        line_color : list of integers
            color of line
        arc_Type : str
            something
        ...
        pckt = Packet(
                    ...
                    polyline=Polyline(positions=PositionList(references=L),
                                      ...
                                      material=Material(solidColor=SolidColorMaterial(color=Color(rgba=line_color if line_color is not None else [0,255,255,255])))),
